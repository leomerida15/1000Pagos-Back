...
export class migrationV41637950495273 implements MigrationInterface {
	name = 'migrationV41637950495273';

	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "fm_type_request2" ("id" int NOT NULL IDENTITY(1,1), "name" nvarchar(255) NOT NULL, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_f39703df7a0782dcf14f1ac3c6f" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_bb8415007faa6f34aa108f5be64" DEFAULT getdate(), CONSTRAINT "PK_809643386399dbbdf1f5025d93d" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "fm_request" ADD CONSTRAINT "FK_8e6a76c31cf8fb8ef74f4823e10" FOREIGN KEY ("id_type_request") REFERENCES "fm_type_request2"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
		);
		await queryRunner.query(
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`DROP TABLE "fm_type_request2"`);
	}
}

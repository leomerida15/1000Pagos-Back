...
export class v11_migration_1638284398099 implements MigrationInterface {
    name = 'v11_migration_1638284398099'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "fm_location" ("id" int NOT NULL IDENTITY(1,1), "sector" nvarchar(255), "calle" nvarchar(255), "local" nvarchar(255), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_606e17763afea82bcc8c6842275" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_8f15e5e70d357faad50dafcecd6" DEFAULT getdate(), "id_estado" int, "id_municipio" int, "id_ciudad" int, "id_parroquia" int, CONSTRAINT "PK_0192539649646c28258e50dfd76" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "fm_department" ("id" int NOT NULL IDENTITY(1,1), "name" nvarchar(255), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_88e4e6cd33457fb1d2786f6a632" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_889fc26b13d39fe4ea250bbfa4c" DEFAULT getdate(), CONSTRAINT "PK_eadfe195782d7e0aebd062cccb9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "fm_client" ("id" int NOT NULL IDENTITY(1,1), "name" nvarchar(255), "last_name" nvarchar(255), "id_roles" int NOT NULL CONSTRAINT "DF_e96551b15403a944c714d6bc07f" DEFAULT 1, "password" nvarchar(255) NOT NULL, "id_ident_type" int, "ident_num" nvarchar(255), "email" nvarchar(255) NOT NULL, "rc_ident_card" int, "ref_person_1" nvarchar(255) NOT NULL, "ref_person_2" nvarchar(255) NOT NULL, "id_location" int, CONSTRAINT "UQ_2b426d3e17a73aa07179aeb223d" UNIQUE ("email"), CONSTRAINT "PK_36e96bfb34ce29232f54023c5b7" PRIMARY KEY ("id"))`);
